 ...
 * Time: 4:06 PM
 */
class IpadQuiz extends MY_Controller
{
    private $Question = "The iPad is a product of?";
    private $Answers = array('Apple','Microsoft');
    ...
    function __construct()
    {
        ...
        if( !$this->Country )
            show_error("iPad Quiz cannot be shown if country is not specified!");
