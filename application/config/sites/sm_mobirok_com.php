...
$config['undefined']['sitename'] = 'Mobirok';
$config['undefined']['homepage'] = 'http://www.mobirok.com';

$country = CANADA;
$config[$country]['sitename'] = 'Mobirok';
...
$config[$country]['frequency']['iq'] = "5x/week";
$config[$country]['frequency']['macquiz'] = "5x/week";
$config[$country]['frequency']['ipadquiz'] = "5x/week";
...
$config[$country]['terms']['long'] = "long terms and conditions";
$config[$country]['frequency']['iq'] = "daily messages";
$config[$country]['frequency']['lovecalculator'] = "daily messages";
...
$config[$country]['terms']['short'] = "This is a subscription service. Cost is £2 per message until you send STOP to 85900.
        ...
        ";
$config[$country]['terms']['long'] = "long terms and conditions";
$config[$country]['frequency']['iq'] = "4x/week";
$config[$country]['frequency']['iq2'] = "4x/week";
$config[$country]['frequency']['lovecalculator'] = "4x/week";
$config[$country]['frequency']['lovecalculator2'] = "4x/week";
