    ...
    <section class="site-content container clearfix">
        <aside class="column threecol">
            ...
            <div class="widget profile-menu">
                <ul>
                    <li><a href="{DocumentRoot}/{ProductPath}/member/{Country}/{Keyword}">My Membership</a></li>
                    <li class="current"><a href="{DocumentRoot}/{ProductPath}/edit/{Country}/{Keyword}">Edit Profile</a></li>
                </ul>
            </div>
