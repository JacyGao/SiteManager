        ...
        <div class="item-slider" style="margin-top:15px;">
            ...
            <div class="overview">
                ...
                <div class="left-panel">
                    ...
                    <span class="taxName">Content Type</span>: <span class="taxContent">{Item_Type}</span>

                    <div class="separator">&nbsp;</div>

                    <span class="taxName">Category</span>: <span class="taxContent">
                    <!--
                    <a href="{DocumentRoot}/{ProductPath}/category/{Country}/{Keyword}/{Item_Type}/{Item_Category}" rel="tag">{Item_Category}</a>
                    -->
                    {Item_Category}
                    </span>
