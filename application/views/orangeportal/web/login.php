...
<table width="100%" border="0">
    <tr>
        ...
        <td width="85%" align="center" style="font-family:Arial, Helvetica, sans-serif; color:black;">Please enter your mobile number</td>
    </tr>
    <tr>
...
<!--Icons-->        
  ...
  <tr>
   ...
   <td width="34%"><a href="{DocumentRoot}/{ProductPath}/content/{Country}/{Keyword}/covertones"><img src="/css/{ProductPath}/images/bmusic.png" width="116" height="67" /></a></td>
