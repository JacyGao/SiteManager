...
<table width="90%" border="0" align="center" class="{profile}">
    ...
    <?if($ShowLogo == 1):?>
    <tr>
        <td align="center"><img src="/custom/images/header.jpg" width="{LogoWidthWeb}" height=""/></td>
    </tr>
    <?endif;?>
    ...
    <!-- Show text above image if necessary -->
    <tr>
        <td align="center">{TextAboveImage}</td>
    </tr>

    <!-- Get body image url -->
    <!-- Images should be uploaded to {host}/custom/images/-->
    <tr>
        <td align="center"><img class="body-image" src="{DocumentRoot}/css/{ProductPath}/images/{BodyImageURL}" width="{BodyImageWidthWeb}" height=""></td>
    </tr>
    ...
    <tr>
        <td><p align="center" style="font-size:14px; font-weight:bold;">SMS <font color=red> <?= str_replace('_', ' ', $Keyword);?> </font>to <font color=red>{Shortcode}</font></p></td>
    </tr>
    ...
    <tr>
        <td>
            <p align="center" style="font-size:14px; font-weight:bold;">Click to SMS is only available for mobile devices!</p>
        </td>
    </tr>
            ...
            <form method="post" action="{DocumentRoot}/{ProductPath}/validate/{Country}/{Keyword}" name="FrontPage_Form1" target="_self">
                    ...
                    <tr>
                        <td height="" valign="top" align="center">
                            ...
                            <p align="center" style="font-size:14px; font-weight:bold;">
                                <span class="enter-phone">Enter your mobile number:</span><br />
                                <span style="font-size:11px; color:#999999;">(format eg.{MobileExample} <!--{MobileExample}-->)</span>

                                <br>
                                <input type="text" id="mobile" name="mobile" size="25" required placeholder=""
                                       pattern="\d+" style="text-align: left; font-size: 20px; padding-left: 10px; width:208px; height: 45px;" maxlength="10"><br />
                                <span class="pricing-note">{PricingNote}</span>  
                            <!-- submit button image -->
                            </p>
