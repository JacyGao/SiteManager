...
<table width="100%" border="0">
    ...
    <tr>
        <td><h3 style="text-align:center;">
                ...
                <br/><br/>To Chat with HOTTEST Girl in Town
            </h3></td>
    </tr>
    <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td height="280" valign="top" align="center">
                ...
                <p align="center"><input type="image" src="{DocumentRoot}/css/{ProductPath}/images/ca/chatnow.png"  height="50" width="170"></p></td>
        </tr>
    </table>
</form>
<div class="footer">
