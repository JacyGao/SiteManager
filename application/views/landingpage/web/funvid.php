...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    SMS <font color="blue"> <?php echo $kw; ?> </font>to <font color="blue">{Shortcode}</font></h3></td>
  </tr>
  <tr>
    <td align="center">
    ...
    <table width="50%" border="0"  align="center" cellspacing="0" cellpadding="0" bgcolor="#fc7677">
        <tr>
...
<tr>
    <td>
        ...
        <tr>
        <td align="center">
                <img src="{DocumentRoot}/css/{ProductPath}/images/clicksms/badge.jpg" alt="" width="100%" />
                </td>
            <td height="280" valign="top" align="center">
                ...
                <p align="center" style="font-size:14px; font-weight:bold;">
                    ...
                    <span style="font-size:11px; color:#000000;">(format eg.{MobileExample} <!--{MobileExample}-->)</span>
                ...
                <p align="center"><input type="image" src="{DocumentRoot}/css/{ProductPath}/images/cmd_Sub1.png" / height="50" width="170"></p>
            </td>
        </tr>
        </table>
    </td>
...
<p align="center">
    <a href="" style="color: #000000; font-weight: bold;"><img src="{DocumentRoot}/css/{ProductPath}/images/clicksms/previews/preview6.jpg" width="19%" border=0 alt="Video Preview"></a>
    <a href="" style="color: #000000; font-weight: bold;"><img src="{DocumentRoot}/css/{ProductPath}/images/clicksms/previews/preview7.jpg" width="19%" border=0 alt="Video Preview"></a><br />
    <a href="" style="color: #000000; font-weight: bold;"><img src="{DocumentRoot}/css/{ProductPath}/images/clicksms/previews/preview8.jpg" width="19%" border=0 alt="Video Preview"></a>
    <a href="" style="color: #000000; font-weight: bold;"><img src="{DocumentRoot}/css/{ProductPath}/images/clicksms/previews/preview9.jpg" width="19%" border=0 alt="Video Preview"></a><br />
    <a href="" style="color: #000000; font-weight: bold;"><img src="{DocumentRoot}/css/{ProductPath}/images/clicksms/previews/preview10.jpg" width="19%" border=0 alt="Video Preview"></a>
    <a href="" style="color: #000000; font-weight: bold;"><img src="{DocumentRoot}/css/{ProductPath}/images/clicksms/previews/preview11.jpg" width="19%" border=0 alt="Video Preview"></a><br />
</p>
<p>&nbsp;</p>
<p>
