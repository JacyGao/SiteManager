...
if ($mid == 'textplaywin')
    $text = "For your chance to win an iPad mini and Subscribe to get the best Games and Music for R6/day on your phone";
else
    $text = "For your chance to Subscribe to get the best content for R6/day on your phone";
?>
...
<table width="100%" border="0">
    <tr>
        <td><img src="/custom/images/header.jpg" width="100%" height=""></td>
    </tr>
    <tr>
        <td><h3 style="text-align:center;">
                sms <font color=red> {Keyword} </font>to <font color=red>{Shortcode}</font>
                <br/><br/>To get your Unlimited Fun
            </h3></td>
    </tr>
    <tr>
        <td><img src="/custom/images/adver.jpg" width="100%" height=""></td>
    </tr>
</table>
