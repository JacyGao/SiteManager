...
<table width="100%" border="0">
    <tr>
        <td><img src="{DocumentRoot}/css/{ProductPath}/images/header_{Brand}.jpg" width="100%" height=""></td>
    </tr>
    <tr>
        <td><h3 style="text-align:center;">
                sms <font color=red> {Keyword} </font>to <font color=red>{Shortcode}</font>
                <br/><br/>To get your Airtime Voucher
            </h3></td>
    </tr>
    <tr>
        <td><img src="{DocumentRoot}/css/{ProductPath}/images/airtime.jpg" width="100%" height=""></td>
    </tr>
</table>
