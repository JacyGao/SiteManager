...
<div class="wrap">
    ...
    <div class="blue">
        ...
        <table width="100%" bgcolor="#00afe8">

            <tr valign="top">
                <td width="40%">
                    <br /><br />
                    <div><a href="<? echo $smslink?>"><img src="{DocumentRoot}/css/{ProductPath}/images/clicksms/pass.jpg" alt="" width="100%" /></a></div>            </td>
                <td align="center">
                    <h3><a href="<? echo $smslink?>" style="color: #000000;">CLICK HERE</a></h3>
                    <h1><a href="<? echo $smslink?>" style="color: #000000;">AND SMS  to 20019</a></h1>
                    <h5>
                            <a href="<? echo $smslink?>" style="color: #000000;">
                            get your 1000 free credits now. Ksh 30 to join and then Ksh 30 4x/week
                            </a>
                    </h5>
                    <h3><a href="<? echo $smslink?>" style="color: #000000;">TO</a></h3>
                    <h2><a href="<? echo $smslink?>" style="color: #000000;">GET YOUR 1000 FREE CREDITS</a></h2>
                    <h2><a href="<? echo $smslink?>" style="color: #000000;">AND  FREE CREDITS NOW!</a></h2>
                </td>
            </tr>
            <tr>
                <td colspan="2"><small><font color="#999999"></font></small></td>
            </tr>
