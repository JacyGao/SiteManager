...
<div class="wrap">
    ...
    <div class="logo" align="center">
        <img src="{DocumentRoot}/css/{ProductPath}/images/win/header_log.jpg"  width="320" >
    </div> <!-- logo -->
    ...
    <div class="white">
        ...
        <div class="container" style="background-color:#FFF; text-align:center;font-size: 20px; font-family: Arial, Helvetica, sans-serif;">
            ...
            You will also get 1000  credits for <br /><font style="color: blue;">Ringtones</font>, <font style="color: green;">Wallpapers</font>, <font style="color: #ff8c00;">Sound Effects</font>, <font style="color: #b22222;">Videos </font>&amp; <font style="color: #6a5acd;">games</font>
