...
<table width="90%" border="0" align="center" class="gameszw"> 
  ...
  <tr>
    <td align="center"><img class="body-image" src="{DocumentRoot}/css/{ProductPath}/images/gameszw.jpg" /></td>
  </tr>
  <tr>
            ...
            <td valign="top" align="center">
                ...
                <p align="center" style="font-size:14px; font-weight:bold;">
                    ...
                    <input type="text" id="mobile" name="mobile" size="25" required 
                           pattern="\d+" style="text-align: left; fot-size: 20px; padding-left: 10px; width:208px; height: 45px;" maxlength="10"><br />
