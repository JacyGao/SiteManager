...
<p>{WRAPPER_START} </p>
<table width="90%" border="0" align="center" class="worldcup"> 
    <tr>
        <td align="center">
  ...
  <tr>
    <td align="center"><img class="body-image" src="{DocumentRoot}/css/{ProductPath}/images/worldcup2014.jpg" /></td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td valign="top" align="center">
                ...
                <p align="center"><input class="button" type="image" src="{DocumentRoot}/css/{ProductPath}/images/btn_download.png" / height="50" width="221"><br/>
