...
if ($mid == 'textplaywin')
    $text = "For your chance to win an iPad mini and Subscribe to get the best Games and Music for R5/day on your phone";
else
    $text = "For your chance to Subscribe to get the best content for R5/day on your phone";
?>
...
<table width="90%" border="0" align="center">
  <tr>
    <td align="center"><img src="{DocumentRoot}/css/{ProductPath}/images/header_{Brand}.jpg" width="100%" height=""></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center">To get your Unlimited Videos</td>
  </tr>
  <tr>
    <td align="center"><img src="{DocumentRoot}/css/{ProductPath}/images/videos.jpg" width="100%" height=""></td>
  </tr>
  <tr>
