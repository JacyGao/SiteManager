<?php include("inc_head.php"); ?>
    ...
    <div align="center">
        ...
        <img src="{DocumentRoot}/css/{ProductPath}/images/{ImageURL}" width="450px"  height="550px" alt="" />
...
<!-- sec1 part -->
    ...
    To complete, click the button below
        ...
        <div align="center">
            <img src="{DocumentRoot}/css/{ProductPath}/images/main2.jpg" width="450px"  height="550px" alt="" />
        </div>
